workspace "gta3-animated-objects"
	configurations { "ReleaseIII", "DebugIII" }
	location "project_files"
   
project "gta3-animated-objects"
	kind "SharedLib"
	language "C++"
	...
	filter { "configurations:*III" }
		...
		targetname "AnimatedObjectsIII"
		debugdir "$(GTA_III_DIR)"
		debugcommand "$(GTA_III_DIR)/gta3.exe"
		postbuildcommands "copy /y \"$(TargetPath)\" \"$(GTA_III_DIR)\\scripts\\AnimatedObjectsIII.asi\""
